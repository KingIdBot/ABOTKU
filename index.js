	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				user: 'Maaf Bro Kamu Belum Terdaftar Di Data Base Kami Silakan Ketik ${prefix}user',
			...
			const ownerNumber = ["18313535216@s.whatsapp.net"] // Nomor Kamu 
            const vipNumber = ["6282246586611@s.whatsapp.net"] // jangan di ubah su
